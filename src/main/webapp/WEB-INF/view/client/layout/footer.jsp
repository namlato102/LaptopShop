            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <a href="/" target="_blank">
                        ...
                        <p class="text-secondary mb-0">@namlato102</p>
                    </a>
                </div>
            </div>
        </div>
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p>Github: <a href="https://github.com/namlato102" target="_blank"> namlato102</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light"><a href="#" target="_blank">
                    <i class="fas fa-copyright text-light me-2"></i>Laptop Shop 2024</a>, All right reserved.
                </span>
            </div>
